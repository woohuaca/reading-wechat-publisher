...
4. Design the imagery plan.
   ...
   - Knowledge cards: use `guizang-social-card-skill` first for Swiss/editorial cards; use `imagegen` only when the content specifically needs a generated diagram, matrix, timeline, or concept illustration.
